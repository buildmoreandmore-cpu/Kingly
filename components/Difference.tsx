...
const Difference: React.FC = () => {
  return (
    <section id="difference" className="py-24 bg-navy-dark text-white overflow-hidden relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold mb-4">The Kingly Difference</h2>
        ...
        <div className="max-w-4xl mx-auto overflow-hidden rounded-3xl border border-white/10 bg-white/5 backdrop-blur-sm shadow-2xl">
          <table className="w-full text-left">
            <thead>
              <tr className="border-b border-white/10">
                <th className="p-8 text-xl font-bold">Feature</th>
                <th className="p-8 text-xl font-bold text-slate-400 hidden sm:table-cell">Traditional Consultants</th>
            ...
            <tbody>
              {[
                ...
                <tr key={idx} className="border-b border-white/5 hover:bg-white/5 transition-colors">
                  <td className="p-8 font-semibold">{feature}</td>
                  <td className="p-8 text-slate-400 hidden sm:table-cell">
                    <div className="flex items-center gap-2">
                       <XCircle size={18} className="text-red-400/50" />
                       {trad}
                    </div>
                  </td>
                  <td className="p-8 text-[#C9A961] font-bold">
                    <div className="flex items-center gap-2">
                       <ShieldCheck size={18} className="text-[#C9A961]" />
                       {kingly}
                    </div>
                  </td>
                </tr>
      ...
      {/* Decorative gradient */}
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#C9A961]/10 rounded-full blur-[120px] -translate-y-1/2 translate-x-1/2"></div>
