        ...
        <div className="max-w-xl">
          ...
          <div className="flex items-start gap-3 sm:gap-4 lg:gap-6 mb-8 sm:mb-12 lg:mb-16">
            ...
            <p className="text-lg lg:text-xl text-gray-800 leading-relaxed font-medium">
              With a proven track record in legal operations, we bridge the gap from medical records to compelling demands and matter routing with AI built for your workflow.
            </p>
          </div>
